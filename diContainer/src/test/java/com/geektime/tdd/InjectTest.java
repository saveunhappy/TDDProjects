...
public class InjectTest {
    ...
    public void setup() throws NoSuchFieldException {
        ...
        //ofNullable又包了一下，明白了
        when(context.get(eq(Context.ComponentRef.of(dependencyProviderType)))).thenReturn(Optional.of(dependencyProvider));
    }
    ...
    public class ConstructorInjection {
        ...
        class Injection {
            ...
            public void should_include_dependency_from_inject_constructor() {
                ...
                assertArrayEquals(new Context.ComponentRef[]{Context.ComponentRef.of(Dependency.class)}, provider.getDependencies().toArray());
            }
            @Test
            public void should_include_provider_type_from_inject_constructor() {
                ...
                assertArrayEquals(new Context.ComponentRef[]{Context.ComponentRef.of(dependencyProviderType)}, provider.getDependencies().toArray());
